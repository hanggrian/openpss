...
package com.hendraanggrian.openpss.scene.layouts

import com.hendraanggrian.openpss.scene.R
import com.hendraanggrian.openpss.core.toJava
import com.hendraanggrian.openpss.core.toJoda
...
inline fun LayoutManager<Node>.dateBox(
    prefill: LocalDate = now(),
    init: (@LayoutDsl DateBox).() -> Unit
): DateBox = com.hendraanggrian.openpss.scene.layouts.dateBox(prefill, init).add()