...
@JvmOverloads inline fun ChildRoot.hostField(noinline init: ((@SceneDsl HostField).() -> Unit)? = null): HostField = HostField().apply { init?.invoke(this) }.add()
@JvmOverloads inline fun ItemRoot.hostField(noinline init: ((@SceneDsl HostField).() -> Unit)? = null): HostField = HostField().apply { init?.invoke(this) }.add()
