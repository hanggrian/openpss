...
class PaymentController : FinancialController<Payment>() {
    ...
    override val rightButtons: List<Node> get() = listOf(dateBox)
    ...
    override fun view(item: Payment) = ViewInvoiceDialog(this, transaction { Invoices[item.invoiceId].single() }).show()
